...
function library.new(library, name, theme)
    ...
    local config = {
        ...
        TabColor = Color3.fromRGB(40, 40, 40), -- Tab 背景色
        Bg_Color = Color3.fromRGB(50, 50, 50), -- 背景色
        Zy_Color = Color3.fromRGB(60, 60, 60), -- 边框颜色

        Button_Color = Color3.fromRGB(70, 70, 70), -- 按钮颜色
        Textbox_Color = Color3.fromRGB(80, 80, 80), -- 输入框颜色
        Dropdown_Color = Color3.fromRGB(90, 90, 90), -- 下拉菜单颜色
        Keybind_Color = Color3.fromRGB(100, 100, 100), -- 快捷键颜色
        Label_Color = Color3.fromRGB(110, 110, 110), -- 标签颜色

        Slider_Color = Color3.fromRGB(120, 120, 120), -- 滑块颜色
        SliderBar_Color = Color3.fromRGB(130, 130, 130), -- 滑块条颜色

        Toggle_Color = Color3.fromRGB(140, 140, 140), -- 切换按钮颜色
        Toggle_Off = Color3.fromRGB(150, 150, 150), -- 切换按钮关闭颜色
        Toggle_On = Color3.fromRGB(160, 160, 160), -- 切换按钮开启颜色
    }
    ...
    function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
            ...
            local SearchBox = Instance.new("TextBox") -- 搜索框
            local SearchBoxC = Instance.new("UICorner") -- 搜索框圆角
            ...
            SearchBox:GetPropertyChangedSignal("Text"):Connect(function()
                ...
                for _, obj in ipairs(Objs:GetChildren()) do
                    if obj:IsA("TextButton") or obj:IsA("TextLabel") then
                        if searchText == "" or obj.Text:lower():find(searchText) then
                            obj.Visible = true
                        else
                            obj.Visible = false
                        end
