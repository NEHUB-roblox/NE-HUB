...
function library.new(library, name, theme)
	...
	local config = {
		...
		Textbox_Color = Color3.fromRGB(70, 70, 70),
		Dropdown_Color = Color3.fromRGB(80, 80, 80),
		Keybind_Color = Color3.fromRGB(90, 90, 90),
		Label_Color = Color3.fromRGB(100, 100, 100),

		Slider_Color = Color3.fromRGB(110, 110, 110),
		SliderBar_Color = Color3.fromRGB(120, 120, 120),

		Toggle_Color = Color3.fromRGB(130, 130, 130),
		Toggle_Off = Color3.fromRGB(140, 140, 140),
