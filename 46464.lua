...
function library.new(library, name, theme)
    ...
    Main.Size = UDim2.new(0, 600, 0, 400) -- 增大UI尺寸
    Main.ZIndex = 1
    Main.Active = true
    Main.Draggable = true
    ...
    UICornerMain.CornerRadius = UDim.new(0, 15) -- 增大圆角
    ...
    MainC.CornerRadius = UDim.new(0, 15)
    MainC.Name = "MainC"
    MainC.Parent = Main
    ...
    SB.Size = UDim2.new(0, 8, 0, 400) -- 调整侧边栏高度
    ...
    Side.Size = UDim2.new(0, 110, 0, 400) -- 调整侧边栏高度
    ...
    function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
            ...
            local SearchBox = Instance.new("TextBox") -- 添加搜索框
            ...
            SectionC.CornerRadius = UDim.new(0, 15) -- 增大圆角
            ...
            SectionText.TextColor3 = Color3.fromRGB(173, 216, 230) -- 蓝色文字
            ...
            SearchBox.Position = UDim2.new(0.0887396261, 0, 0, 0)
            SearchBox.Size = UDim2.new(0, 200, 0, 30)
            SearchBox.Font = Enum.Font.GothamSemibold
            SearchBox.PlaceholderText = "搜索功能"
            SearchBox.PlaceholderColor3 = Color3.fromRGB(255, 182, 193) -- 粉色文字
            SearchBox.TextColor3 = Color3.fromRGB(255, 182, 193) -- 粉色文字
            ...
            function section.Button(section, text, callback)
                ...
                BtnC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                BtnC.Name = "BtnC"
                BtnC.Parent = Btn
            ...
            function section:Label(text)
                ...
                LabelC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                LabelC.Name = "LabelC"
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtnC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                ...
                ToggleSwitchC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                ToggleSwitchC.Name = "ToggleSwitchC"
                ToggleSwitchC.Parent = ToggleSwitch

                ToggleDisableC.CornerRadius = UDim.new(0, 15) -- 增大圆角
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindBtnC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                ...
                KeybindValueC.CornerRadius = UDim.new(0, 15) -- 增大圆角
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxBackC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                ...
                BoxBGC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                BoxBGC.Name = "BoxBGC"
                BoxBGC.Parent = BoxBG
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderBackC.CornerRadius = UDim.new(0, 15) -- 增大圆角
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownTopC.CornerRadius = UDim.new(0, 15) -- 增大圆角
                ...
                funcs.AddOption = function(self, option)
                    ...
                    OptionC.CornerRadius = UDim.new(0, 15) -- 增大圆角
    ...
    local ToggleUIButtonText = Instance.new("TextLabel")

    ToggleUIButton.Name = "ToggleUIButton"
    ToggleUIButton.Parent = Main
    ToggleUIButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- 红色
    ToggleUIButton.BorderSizePixel = 0
    ToggleUIButton.Position = UDim2.new(0.5, -50, 0.5, -25)
    ...
    ToggleUIButton.TextSize = 16.000

    ToggleUIButtonC.CornerRadius = UDim.new(0, 25) -- 增大圆角
    ToggleUIButtonC.Name = "ToggleUIButtonC"
    ToggleUIButtonC.Parent = ToggleUIButton

    ToggleUIButtonText.Name = "ToggleUIButtonText"
    ToggleUIButtonText.Parent = ToggleUIButton
    ToggleUIButtonText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ToggleUIButtonText.BackgroundTransparency = 1.000
    ToggleUIButtonText.Position = UDim2.new(0, 0, 0, 0)
    ToggleUIButtonText.Size = UDim2.new(1, 0, 1, 0)
    ToggleUIButtonText.Font = Enum.Font.GothamSemibold
    ToggleUIButtonText.Text = "开启"
    ToggleUIButtonText.TextColor3 = Color3.fromRGB(255, 255, 255)
    ToggleUIButtonText.TextSize = 16.000
    ToggleUIButtonText.TextScaled = true
    ToggleUIButtonText.TextXAlignment = Enum.TextXAlignment.Center

    local toggleState = false
    ToggleUIButton.MouseButton1Click:Connect(function()
        toggleState = not toggleState
        if toggleState then
            Tween(ToggleUIButton, { 0.3, "Sine", "InOut" }, { BackgroundColor3 = Color3.fromRGB(0, 0, 255) }) -- 蓝色
            ToggleUIButtonText.Text = "关闭"
        else
            Tween(ToggleUIButton, { 0.3, "Sine", "InOut" }, { BackgroundColor3 = Color3.fromRGB(255, 0, 0) }) -- 红色
            ToggleUIButtonText.Text = "开启"
        end
    end)
